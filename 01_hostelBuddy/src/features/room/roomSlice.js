...
const initialState = {
    room:[
        {id:nanoid(),title:"Room Number 1",image:"https://images.unsplash.com/photo-1611892440504-42a792e24d32?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8aG90ZWwlMjByb29tfGVufDB8fDB8fHww",price:1000,description:"very nice room",new:true},
...
export const roomSlice = createSlice({
    ...
    reducers: {
        removeRoom: (state,action) => {
            state.room = state.room.filter((prev) => (prev.id !== action.payload))
        }
    }
})

const {removeRoom} = roomSlice.actions
