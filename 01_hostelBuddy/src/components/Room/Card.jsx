                ...
                >
                  ...
                  <div className="relative px-4 -mt-16  ">
                    ...
                    <div className="flex justify-around py-4 ">
                      ...
                      <button  onClick={() => details.updateClick(details)} className={`uppercase ${details.admin?"":"hidden"} bg-amber-500 hover:bg-amber-600 w-32 text-white h-9 rounded-md`}>update</button>
