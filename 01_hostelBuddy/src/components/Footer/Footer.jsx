...
function Footer() {
    return (
        ...
        <div className="w-80 h-60 bg-yellow-600 p-4">
        ...
        <div className="flex flex-col space-y-2">
            <div className="flex mb-4">
                <div className="mx-2 uppercase font-bold text-yellow-500">Contact</div>
        ...
        <div className="flex flex-col space-y-2">
            <div className="flex mb-4">
                <div className="mx-2 uppercase font-bold text-yellow-500">company</div>
                <div className=" w-16 h-1 border-2 border-yellow-400 rounded-2xl mt-[11px] mb-2"></div>
            </div>
        ...
        <div className="flex flex-col space-y-2">
            <div className="flex mb-4">
                <div className="mx-2 uppercase font-bold text-yellow-500">service</div>
                <div className=" w-16 h-1 border-2 border-yellow-400 rounded-2xl mt-[11px] mb-2"></div>
            </div>
            <div>123 Street, New York, USA</div>
            <div>+012 345 67890</div>
